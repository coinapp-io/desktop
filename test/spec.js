...
describe('CoinApp Transaction Viewing', () => {
    ...
    it('should open Litecoin and view transaction', () => {
        return app.client.waitUntilWindowLoaded()
            ...
            .click('#unlock_priv_key').pause(15000)
            .getText(".myaddress")
            .should.eventually.equal("mnJQyeDFmGjNoxyxKQC6MMFdpx77rYV3Bo")
            .click('//*[@class="row transaction_box"]/div[2]/button').pause(4000)
            .getText("#tx_view_height")
            .should.eventually.equal("115")
    });
...
describe('CoinApp Transaction Testing', () => {
    ...
    it('should open token sending modal and send tokens', () => {
        return app.client.waitUntilWindowLoaded()
            ...
            .click('#tokens_available-tab').pause(4000)
            .click('#new_token_dialog_btn').pause(4000)
            ...
            .click('#savetokenbutton').pause(4000)
            .click("#token_0xe78a0f7e598cc8b0bb87894b0f60dd2a88d6a8ab").pause(6000)
            .getText("#token_bal")
            .should.eventually.equal("10000000.0")
            .click("#send_tokens_btn").pause(4000)
    ...
    it('should open litecoin sending modal and send LTC', () => {
        return app.client.waitUntilWindowLoaded()
            ...
            .should.eventually.equal(LTC_PRIV)
            .click("//select/option[@value=\'ltctest\']")
            .click('#unlock_priv_key').pause(50000)
            .getText(".myaddress")
            .should.eventually.equal("mnJQyeDFmGjNoxyxKQC6MMFdpx77rYV3Bo")
            .click('#send_ether_btn').pause(7000)
